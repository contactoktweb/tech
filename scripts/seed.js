...
async function run() {
      ...
      },
      {
        ...
        services: [
          ...
          },
          {
            ...
            description: 'Acompañamiento integral en el proceso de transformación digital de tu organización. Desde la evaluación de procesos actuales hasta la implementación de herramientas tecnológicas que impulso la eficiencia y competitividad.',
          },
          {
            _key: 's4-4',
  ...
  // 11. Seed dynamic Categories (Portátiles & Accesorios)
  console.log('Sembrando Documentos de Categorías (Colecciones)...')
  ...
  // 12. Seed dynamic Brands (HP, Dell, Lenovo)
  console.log('Sembrando Documentos de Marcas...')
  const brandsList = [
  ...
  for (const br of brandsList) {
    await client.createOrReplace(br)
  }

  // 13. Seed Products referencing categories and brands
      ...
      variations: [
        {
          ...
          name: 'Procesador',
          options: [
            { _key: 'op1-1-1', value: 'Intel Core i7', priceModifier: 0 },
            { _key: 'op1-1-2', value: 'Intel Core i5', priceModifier: -400000 }
          ]
        },
        {
          _key: 'v1-2',
          name: 'Memoria RAM',
          options: [
            { _key: 'op1-2-1', value: '16GB', priceModifier: 0 },
            { _key: 'op1-2-2', value: '32GB', priceModifier: 650000 }
          ]
        },
        {
          _key: 'v1-3',
          name: 'Almacenamiento',
          options: [
            { _key: 'op1-3-1', value: '512GB SSD', priceModifier: 0 }
          ]
        }
      ],
    },
      ...
      variations: [
        {
          ...
          name: 'Procesador',
          options: [
            { _key: 'op2-1-1', value: 'Intel Core i9', priceModifier: 0 }
          ]
        },
        {
          _key: 'v2-2',
          name: 'Memoria RAM',
          options: [
            { _key: 'op2-2-1', value: '32GB', priceModifier: 0 }
          ]
        },
        {
          _key: 'v2-3',
          name: 'Almacenamiento',
          options: [
            { _key: 'op2-3-1', value: '1TB SSD', priceModifier: 0 }
          ]
        }
      ],
    },
      ...
      variations: [
        {
          ...
          name: 'Procesador',
          options: [
            { _key: 'op3-1-1', value: 'Intel Core i7', priceModifier: 0 }
          ]
        },
        {
          _key: 'v3-2',
          name: 'Memoria RAM',
          options: [
            { _key: 'op3-2-1', value: '16GB', priceModifier: 0 }
          ]
        },
        {
          _key: 'v3-3',
          name: 'Almacenamiento',
          options: [
            { _key: 'op3-3-1', value: '512GB SSD', priceModifier: 0 }
          ]
        }
      ],
    },
